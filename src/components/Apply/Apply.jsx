...
const Apply = () => {
  ...
  const investmentRanges = [
    ...
    "1,000,000 - 1,250,000 ريال",
    "1,250,000 - 1,500,000 ريال",
    "1,500,000 - 1,750,000 ريال",
    "1,750,0000 - 2,000,000 ريال",
  ];
  ...
  return (
    <>
      <ApWrap>
        <ApSubWrap>
          <ApConOn>
            <ApHe>حان الوقت لتملك عقارك بسهولة</ApHe>
            <ApHeBe>
              الآن يمكنك العثور على شريك يساعدك في شراء العقار وتقسيمه معه،
              لتبدأ رحلتك في الاستثمار العقاري بثقة وسهولة
            </ApHeBe>
            <ApHeDi></ApHeDi>
          </ApConOn>
          <ApConTw>
              ...
              <AqSec>
                <AqSubSec>
                  <AqAra>
                    <AqAraOne>
                      <AqAraOnePa>
                        خُذ الخطوة الأولى لبدء مسيرتك العقارية
                      </AqAraOnePa>
                    </AqAraOne>
                    <AqAraTwo>
